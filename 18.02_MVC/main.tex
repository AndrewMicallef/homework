...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Math shortcuts
\newcommand{\bi}{{\color{i}\vec{i}}}
\newcommand{\bj}{{\color{j}\vec{j}}}
\newcommand{\bk}{{\color{k}\vec{k}}}
...
%\subfile{C_determinant/1C-2.tex}
%\subfile{C_determinant/1C-5.tex}
%\subfile{D_crossprod/1D-2.tex}
%\subfile{D_crossprod/1D-5.tex}
%\subfile{D_crossprod/1D-7.tex}
